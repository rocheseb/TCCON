...
python get_MERRA2.py collection=c dates=d1,d2 lon=lon1,lon2 lat=lat1,lat2 var=var1,var2,var3
...
if __name__=="__main__":
	...
	URLlist_MERRA2(collection,date_range=date_range,lat_range=lat_range,lon_range=lon_range,variables=variables)
	
	for line in execute('wget --load-cookies /home/sroche/.urs_cookies --save-cookies /home/sroche/.urs_cookies --auth-no-challenge=on --keep-session-cookies --content-disposition -i getMERRA2.dat'.split()):
		print(line, end="")